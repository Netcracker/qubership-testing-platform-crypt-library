...
public class AtpDecryptorConfiguration extends AtpCryptoConfiguration {
     ...
     */
    @Bean("atpDecryptor")
    public Decryptor atpDecryptor() throws AtpCryptInvalidKeyException, AtpDecryptException {
        ...
        return AtpCryptoFactory.createDefaultAesDecryptor(rsaDecryptor.decrypt(key));
    }
}
